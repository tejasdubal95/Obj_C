...
//  UIDemo
//
//  Created by Student P_10 on 22/08/17.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
   ...
   // _window.rootViewController = loginvc;
    ...
    //Slider *sliderv  = [[Slider alloc]init];
    //_window.rootViewController = sliderv;
    
    
    [_window makeKeyAndVisible];
    
   // PickerViewController *pcv=[[PickerViewController alloc]init];
    //_window.rootViewController = pcv;
    
    //DateViewController *dvc = [[DateViewController alloc]init];
    //_window.rootViewController = dvc;
    
    //PickerAssignmentViewController *pavc = [[PickerAssignmentViewController alloc]init];
    //_window.rootViewController = pavc;
    
    CalculaterViewController *cvc = [[CalculaterViewController alloc]init];
    _window.rootViewController = cvc;
    return YES;
}
